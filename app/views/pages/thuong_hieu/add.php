    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="/admin/thuong-hieu/add">Thêm</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="basic-form">
                        <form method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-default " id="ten" name="ten" placeholder="Tên thương hiệu">
                            </div>
